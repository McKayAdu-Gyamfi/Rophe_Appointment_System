      ...
      <div className="max-h-[90vh] w-full overflow-y-auto rounded-t-2xl bg-white shadow-xl sm:max-w-lg sm:rounded-2xl">
        ...
        <div className="flex items-start justify-between gap-3 border-b border-slate-100 p-5">
          <div className="flex min-w-0 items-center gap-3">
            <span className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-teal-50 text-sm font-semibold text-teal-700">
        ...
        <div className="space-y-3 p-5">
          ...
          {appointment.notes && (
            <div className="flex items-start gap-2.5 rounded-xl border border-slate-100 px-4 py-3 text-sm text-slate-600">
